...
int main(int argc, char** argv)
{
    ...
    if(_hdc)
    {
       ...
       if(_red1<max_r&&_green1<max_g&&_blue1<max_b&&clock()-t1>70)
        ...
        if(_red2<max_r&&_green2<max_g&&_blue2<max_b&&clock()-t2>70)
        ...
        if(_red3<max_r&&_green3<max_g&&_blue3<max_b&&clock()-t3>70)
        ...
        if(_red4<max_r&&_green4<max_g&&_blue4<max_b&&clock()-t4>70)
